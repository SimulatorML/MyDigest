...
class UserStates(StatesGroup):
    waiting_for_channels = State()  # Состояние ожидания ввода каналов
    waiting_for_delete = State()  # Добавляем новое состояние для удаления
...
@dp.message(Command(commands='add_channels'))
...
@dp.message(UserStates.waiting_for_channels)
...
@dp.message(Command(commands='show_channels'))
...
@dp.message(UserStates.waiting_for_delete)
